...
BannerRouter.get('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                banners = _a.sent();
                return [2 /*return*/, response.json(banners)];
        }
    });
}); });
BannerRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, imagem, nome, createBanner, banner, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = request.body, imagem = _a.imagem, nome = _a.nome;
                createBanner = new CreateBannerService_1.default();
                return [4 /*yield*/, createBanner.execute({
                        imagem: imagem,
                        nome: nome,
                    })];
            case 1:
                banner = _b.sent();
                return [2 /*return*/, response.json(banner)];
            case 2:
                error_1 = _b.sent();
...
BannerRouter.delete('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var nome, deleteBanner, isdeleted, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                nome = request.body.nome;
                deleteBanner = new DeleteBannerService_1.default();
                return [4 /*yield*/, deleteBanner.execute({
                        nome: nome
                    })];
            case 1:
                isdeleted = _a.sent();
