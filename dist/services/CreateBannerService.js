...
var CreateProductService = /** @class */ (function () {
    ...
    CreateProductService.prototype.execute = function (_a) {
        var imagem = _a.imagem, nome = _a.nome;
        return __awaiter(this, void 0, void 0, function () {
            var bannersrepository, findBanner, findBannerbyName, banner;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        bannersrepository = typeorm_1.getCustomRepository(BannersRepository_1.default);
                        return [4 /*yield*/, bannersrepository.findOne(imagem)];
                    case 1:
                        findBanner = _b.sent();
                    ...
                    case 2:
                        ...
                        banner = bannersrepository.create({
                            imagem: imagem,
                            nome: nome,
                        });
                        return [4 /*yield*/, bannersrepository.save(banner)];
                    case 3:
                        _b.sent();
